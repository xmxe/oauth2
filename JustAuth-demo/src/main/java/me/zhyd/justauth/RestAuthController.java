...
import me.zhyd.justauth.custom.LoginPlatFormEnum;
...
public class RestAuthController {
    ...
    public void renderAuth(@PathVariable("source") String source, HttpServletResponse response) throws IOException {
        ...
        LoginPlatFormEnum loginPlatFormEnum = LoginPlatFormEnum.getLoginPlatForm(source);
        AuthRequest authRequest = getAuthRequest(loginPlatFormEnum);
...
//                        .redirectUri("http://localhost:9001/oauth/baidu/callback")
     ...
     * 根据具体的授权来源，获取授权请求工具类
     *
     * @param loginPlatFormEnum
     * @return
     */
    private AuthRequest getAuthRequest(LoginPlatFormEnum loginPlatFormEnum) {
        AuthRequest authRequest = null;
        switch (loginPlatFormEnum) {
            case DINGTALK:
                authRequest = new AuthDingTalkRequest(AuthConfig.builder()
                        .clientId("")
                        .clientSecret("")
